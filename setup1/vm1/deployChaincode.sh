...
presetup() {
    ...
    pushd ./../../artifacts/src/github.com/fabtmp/go
...
VERSION="1"
CC_SRC_PATH="./../../artifacts/src/github.com/fabtmp/go"
CC_NAME="fabtmp"
...
approveForMyOrg1() {
    ...
    peer lifecycle chaincode approveformyorg -o 34.125.43.122:7050 \
...
commitChaincodeDefination() {
    setGlobalsForPeer0Org1
    peer lifecycle chaincode commit -o 34.125.43.122:7050 --ordererTLSHostnameOverride orderer.example.com \

...
func (s *SmartContract) registerSensor(stub shim.ChaincodeStubInterface, args []string) sc.Response {
...
func (s *SmartContract) addTemp(stub shim.ChaincodeStubInterface, args []string) sc.Response {
